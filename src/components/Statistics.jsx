                ...
                stats.map(stat => (
                  ...
                  <div key={s.type}  className='divide-y divide-black'>
                      ...
                      <div className='flex items-center justify-center gap-2  w-full py-2'>
                        ...
                        <div className={s.type === 'Ball Possession' ? `w-[${parseInt(s.home.slice(0,s.home.indexOf('%')))}%]` :`w-[${Math.round(((+s.home * 100)/(+s.home + +s.away)))}%] bg-[#042a2b] h-[6px]  `}></div>
                        ...
                        <div className={s.type === 'Ball Possession' ? `w-[${s.away}]` :`w-[${Math.round(((+s.away * 100)/(+s.home + +s.away)))}%]  bg-[#042a2b] h-[6px] `}></div>
                        </div>
                      </div>

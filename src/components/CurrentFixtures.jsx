...
const CurrentFixtures = ({}) => {
  ...
  return (
    <div className='grid md:grid-cols-5 '>
      <div className='col-span-2 w-[90%]  max-w-[700px] mx-auto '>
        {
          match.map(match => (
                              ...
                              stats.map(stat => (
                                ...
                                <div key={s.type}  className='divide-y divide-black'>
                                    ...
                                    <div className='flex items-center justify-center gap-2  w-full py-2'>
                                      <div className='w-[45%] bg-white h-[6px] flex justify-end'>
                                      <div className={s.type === 'Ball Possession' ? `w-[${s.home.slice(0,s.home.indexOf('%'))}%]` :`w-[${Math.round(((+s.home * 100)/(+s.home + +s.away)))}%] bg-black h-[6px]  `}></div>

                                      </div>
                                      <div className='flex  w-[100px] justify-center'>{s.home} - {s.away}</div>
                                      <div className='w-[45%] bg-white h-[6px] '>

                                      <div className={s.type === 'Ball Possession' ? `w-[${s.away}]` :`w-[${Math.round(((+s.away * 100)/(+s.home + +s.away)))}%]  bg-black h-[6px]  `}></div>
                                      </div>
                                    </div>

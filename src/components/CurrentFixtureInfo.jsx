    ...
    <div>
        {
          match.map(match => (
            <div key={match.event_key}>
              ...
              <div className=' bg-customBg2 mb-2 text-gray-400 p-2'>{match.event_date}{match.league_name}</div>
                  <div className=' w-full bg-customBg2 text-gray-400 p-2 px-3 grid grid-cols-5 items-center rounded mb-4'>
                    ...
                    <div className={`${match.event_live === '1' ? 'text-live   ' : 'text-gray-400 '} text-center col-span-1 `}>

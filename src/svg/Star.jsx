...
const Star = ({
    ...
    try {
      ...
      if (!Object.keys(favouritesTeams).includes(teamKey)) {
        ...
        setAlertMessage((prevMessages) => ({
          ...prevMessages,
          [`${team.team} added to favourites`]: true,
        }));
        setTimeout(() => {
          setAlertMessage((prevMessages) => ({
            ...prevMessages,
            [`${team.team} added to favourites`]: false,
          }));
        }, 6000);
      } else {
        ...
        setAlertMessage((prevMessages) => ({
          ...prevMessages,
          [`${team.team} removed from favourites`]: true,
        }));
        setTimeout(() => {
          setAlertMessage((prevMessages) => ({
            ...prevMessages,
            [`${team.team} removed from favourites`]: false,
          }));
        }, 6000);
  ...
  return (
    <div
      className={`${user ? "block" : "hidden"} relative `}
      // onMouseOver={(e) =>
